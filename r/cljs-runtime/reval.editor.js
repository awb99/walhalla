...
reval.editor.in_range_QMARK_ = (function reval$editor$in_range_QMARK_(p__55166,p__55167){
var map__55168 = p__55166;
var map__55168__$1 = cljs.core.__destructure_map(map__55168);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55168__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55168__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55168__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55168__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__55169 = p__55167;
var map__55169__$1 = cljs.core.__destructure_map(map__55169);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55169__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55169__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__55173_SHARP_){
return reval.editor.in_range_QMARK_(cljs.core.meta((rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(p1__55173_SHARP_) : rewrite_clj.zip.node.call(null,p1__55173_SHARP_))),pos);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__55178){
var vec__55179 = p__55178;
var fst = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55179,(0),null);
var snd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55179,(1),null);
 ...
 */
reval.editor.block_for = (function reval$editor$block_for(code,p__55186){
var vec__55187 = p__55186;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55187,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55187,(1),null);
...
var map__55192 = (function (){var G__55194 = node_block;
if((G__55194 == null)){
return null;
} else {
return cljs.core.meta(G__55194);
}
})();
var map__55192__$1 = cljs.core.__destructure_map(map__55192);
var row__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55192__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55192__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55192__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55192__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
