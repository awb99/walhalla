...
reval.editor.in_range_QMARK_ = (function reval$editor$in_range_QMARK_(p__54574,p__54575){
var map__54576 = p__54574;
var map__54576__$1 = cljs.core.__destructure_map(map__54576);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54576__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54576__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54576__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54576__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__54577 = p__54575;
var map__54577__$1 = cljs.core.__destructure_map(map__54577);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54577__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54577__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54578_SHARP_){
return reval.editor.in_range_QMARK_(cljs.core.meta((rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(p1__54578_SHARP_) : rewrite_clj.zip.node.call(null,p1__54578_SHARP_))),pos);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54579){
var vec__54580 = p__54579;
var fst = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54580,(0),null);
var snd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54580,(1),null);
 ...
 */
reval.editor.block_for = (function reval$editor$block_for(code,p__54584){
var vec__54585 = p__54584;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54585,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54585,(1),null);
...
var map__54588 = (function (){var G__54589 = node_block;
if((G__54589 == null)){
return null;
} else {
return cljs.core.meta(G__54589);
}
})();
var map__54588__$1 = cljs.core.__destructure_map(map__54588);
var row__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54588__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54588__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54588__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54588__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
