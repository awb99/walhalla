...
reval.editor.in_range_QMARK_ = (function reval$editor$in_range_QMARK_(p__54616,p__54617){
var map__54618 = p__54616;
var map__54618__$1 = cljs.core.__destructure_map(map__54618);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54618__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54618__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54618__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54618__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__54619 = p__54617;
var map__54619__$1 = cljs.core.__destructure_map(map__54619);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54619__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54619__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54620_SHARP_){
return reval.editor.in_range_QMARK_(cljs.core.meta((rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(p1__54620_SHARP_) : rewrite_clj.zip.node.call(null,p1__54620_SHARP_))),pos);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54621){
var vec__54622 = p__54621;
var fst = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54622,(0),null);
var snd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54622,(1),null);
 ...
 */
reval.editor.block_for = (function reval$editor$block_for(code,p__54626){
var vec__54627 = p__54626;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54627,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54627,(1),null);
...
var map__54630 = (function (){var G__54631 = node_block;
if((G__54631 == null)){
return null;
} else {
return cljs.core.meta(G__54631);
}
})();
var map__54630__$1 = cljs.core.__destructure_map(map__54630);
var row__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54630__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54630__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54630__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54630__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
