...
var init_symbol_54684 = cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(symbol_init_as_string);
var libspec_54685 = cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(cljs.core.namespace(init_symbol_54684));
var require_p_54686 = goldly.sci.kernel_cljs.require_async.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([libspec_54685], 0));
require_p_54686.then((function (res){
var init_fn = goldly.sci.kernel_cljs.resolve_symbol(init_symbol_54684);
...
return (goldly.offline.app.error.cljs$core$IFn$_invoke$arity$2 ? goldly.offline.app.error.cljs$core$IFn$_invoke$arity$2("could not resolve init-fn: ",init_symbol_54684) : goldly.offline.app.error.call(null,"could not resolve init-fn: ",init_symbol_54684));
}
}));

require_p_54686.catch((function (err){
