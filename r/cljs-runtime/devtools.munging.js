...
var o40654 = temp__5802__auto__;
var temp__5802__auto____$1 = (o40654["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o40655 = temp__5802__auto____$1;
return (o40655["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40484__auto__ = f;
return (o__40484__auto__["toString"]).call(o__40484__auto__);
} else {
return "";
}
}catch (e40677){var _ = e40677;
return "";
}});
...
try{var o__40484__auto___41431 = t;
(o__40484__auto___41431["cljs$lang$ctorPrWriter"]).call(o__40484__auto___41431,t,writer);
}catch (e40694){var __41433 = e40694;
}
...
var char_code = (function (){var o__40484__auto__ = (new String(char$));
return (o__40484__auto__["charCodeAt"]).call(o__40484__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40484__auto__ = String;
return (o__40484__auto__["fromCharCode"]).call(o__40484__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40738 = num_code;
switch (G__40738) {
case (1):
return (185);
...
var o__40484__auto__ = String;
return (o__40484__auto__["fromCharCode"]).call(o__40484__auto__,superscript_code);
});
/**
...
}catch (e40781){var _e__40508__auto__ = e40781;
return false;
}})())){
...
var vec__40786 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40786,(0),null);
...
var len__5769__auto___41452 = arguments.length;
var i__5770__auto___41453 = (0);
while(true){
if((i__5770__auto___41453 < len__5769__auto___41452)){
args__5775__auto__.push((arguments[i__5770__auto___41453]));

var G__41454 = (i__5770__auto___41453 + (1));
i__5770__auto___41453 = G__41454;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40876){
var vec__40878 = p__40876;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40878,(0),null);
...
var G__41461 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41462 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41461;
remaining_tokens = G__41462;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40859){
var G__40860 = cljs.core.first(seq40859);
var seq40859__$1 = cljs.core.next(seq40859);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40860,seq40859__$1);
}));
...
var vec__40900 = cljs.core.split_with((function (p1__40897_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40897_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40900,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40900,(1),null);
...
var vec__40929 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40929,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40929,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41466 = cljs.core.rest(remaining_tokens);
var G__41467 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41466;
...
var vec__40964 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40964,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40964,(1),null);
var vec__40967 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40967,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40967,(1),null);
var vec__40970 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40970,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40970,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40970,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40970,(3),null);
...
var vec__40999 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40999,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40999,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40999,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40999,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40999,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40999,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__41011 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41011,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41011,(1),null);
var vec__41014 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41014,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41014,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41031 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41031) : devtools.munging.parse_fn_info_deep.call(null,G__41031));
})()));
}
} else {
return fn_info;
...
var G__41480 = (arity + (1));
var G__41481 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41078){
var vec__41079 = p__41078;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41079,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41079,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41114_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41114_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41115_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41115_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___41490 = arguments.length;
var i__5770__auto___41492 = (0);
while(true){
if((i__5770__auto___41492 < len__5769__auto___41490)){
args__5775__auto__.push((arguments[i__5770__auto___41492]));

var G__41494 = (i__5770__auto___41492 + (1));
i__5770__auto___41492 = G__41494;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41135){
var vec__41140 = p__41135;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41140,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41125){
var G__41126 = cljs.core.first(seq41125);
var seq41125__$1 = cljs.core.next(seq41125);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41126,seq41125__$1);
}));
...
var map__41213 = options;
var map__41213__$1 = cljs.core.__destructure_map(map__41213);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41213__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41213__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41213__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41213__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41214 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41214,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41214,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41214,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41214,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41214,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41214,(5),null);
...
var o__40484__auto__ = f;
return (o__40484__auto__["getBasis"]).call(o__40484__auto__);
});
/**
...
}catch (e41232){var _e__40508__auto__ = e41232;
...
var G__41516 = (obj[cljs.core.first(path)]);
var G__41517 = cljs.core.rest(path);
obj = G__41516;
path = G__41517;
continue;
} else {
...
var _STAR_ = (function (accum,p__41344){
var vec__41346 = p__41344;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41346,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41346,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41377){
var vec__41380 = p__41377;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41380,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41380,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41380,(2),null);
...
var post_process = (function (p__41408){
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41394_SHARP_){
return (obj[cljs.core.first(p1__41394_SHARP_)]);
}),sorted_matches);
