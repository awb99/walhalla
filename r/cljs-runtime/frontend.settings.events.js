...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("settings","init","settings/init",-106254215),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"store","store",1512230022))], null),(function (p__45012){
var map__45013 = p__45012;
var map__45013__$1 = cljs.core.__destructure_map(map__45013);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword(null,"db","db",993250759));
var store = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword(null,"store","store",1512230022));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("settings","set","settings/set",1202002397),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"store","store",1512230022))], null),(function (p__45022,p__45023){
var map__45026 = p__45022;
var map__45026__$1 = cljs.core.__destructure_map(map__45026);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45026__$1,new cljs.core.Keyword(null,"db","db",993250759));
var store = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45026__$1,new cljs.core.Keyword(null,"store","store",1512230022));
var vec__45027 = p__45023;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45027,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45027,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45027,(2),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("settings","unset","settings/unset",-1226410607),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"store","store",1512230022))], null),(function (p__45033,p__45034){
var map__45035 = p__45033;
var map__45035__$1 = cljs.core.__destructure_map(map__45035);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45035__$1,new cljs.core.Keyword(null,"db","db",993250759));
var store = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45035__$1,new cljs.core.Keyword(null,"store","store",1512230022));
var vec__45036 = p__45034;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45036,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45036,(1),null);
