...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("settings","init","settings/init",-106254215),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"store","store",1512230022))], null),(function (p__45018){
var map__45019 = p__45018;
var map__45019__$1 = cljs.core.__destructure_map(map__45019);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45019__$1,new cljs.core.Keyword(null,"db","db",993250759));
var store = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45019__$1,new cljs.core.Keyword(null,"store","store",1512230022));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("settings","set","settings/set",1202002397),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"store","store",1512230022))], null),(function (p__45026,p__45027){
var map__45032 = p__45026;
var map__45032__$1 = cljs.core.__destructure_map(map__45032);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45032__$1,new cljs.core.Keyword(null,"db","db",993250759));
var store = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45032__$1,new cljs.core.Keyword(null,"store","store",1512230022));
var vec__45033 = p__45027;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45033,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45033,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45033,(2),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("settings","unset","settings/unset",-1226410607),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"store","store",1512230022))], null),(function (p__45040,p__45041){
var map__45042 = p__45040;
var map__45042__$1 = cljs.core.__destructure_map(map__45042);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45042__$1,new cljs.core.Keyword(null,"db","db",993250759));
var store = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45042__$1,new cljs.core.Keyword(null,"store","store",1512230022));
var vec__45043 = p__45041;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45043,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45043,(1),null);
