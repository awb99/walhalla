...
var G__72628 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__72628__$1 = (((G__72628 == null))?null:cljs.core.iterate((function (loc){
...
var G__72628__$2 = (((G__72628__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__72628__$1));
var G__72628__$3 = (((G__72628__$2 == null))?null:cljs.core.last(G__72628__$2));
if((G__72628__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__72628__$3);
}
} else {
return zloc;
}
...
var G__72672 = rewrite_clj.zip.move.right(v);
var G__72673 = rewrite_clj.zip.move.up(v);
loc = G__72672;
parent = G__72673;
continue;
} else {
var G__72674 = rewrite_clj.zip.move.right(v0);
var G__72675 = parent;
loc = G__72674;
parent = G__72675;
continue;
...
var G__72676 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__72678 = rewrite_clj.zip.move.up(v);
loc = G__72676;
parent = G__72678;
continue;
} else {
var G__72679 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__72680 = parent;
loc = G__72679;
parent = G__72680;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__72654 = zloc;
var G__72654__$1 = (((G__72654 == null))?null:rewrite_clj.zip.move.down(G__72654));
var G__72654__$2 = (((G__72654__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__72654__$1,k));
if((G__72654__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__72654__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__72655 = rewrite_clj.zip.move.down(zloc);
var G__72655__$1 = (((G__72655 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__72655));
if((G__72655__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__72655__$1);
}
})(),k);
}
});
