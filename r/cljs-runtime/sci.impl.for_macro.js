...
var arg_count_64753 = (cljs.core.count(expr) - (1));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((2),arg_count_64753)){
} else {
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2(["Wrong number of args (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(arg_count_64753),") passed to: clojure.core/for"].join(''),expr);
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__64342){
var vec__64346 = p__64342;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64346,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64346,(1),null);
...
var err = (function() { 
var G__64766__delegate = function (msg){
throw (new Error(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg)));
};
var G__64766 = function (var_args){
var msg = null;
if (arguments.length > 0) {
var G__64767__i = 0, G__64767__a = new Array(arguments.length -  0);
while (G__64767__i < G__64767__a.length) {G__64767__a[G__64767__i] = arguments[G__64767__i + 0]; ++G__64767__i;}
  msg = new cljs.core.IndexedSeq(G__64767__a,0,null);
} 
return G__64766__delegate.call(this,msg);};
G__64766.cljs$lang$maxFixedArity = 0;
G__64766.cljs$lang$applyTo = (function (arglist__64768){
var msg = cljs.core.seq(arglist__64768);
return G__64766__delegate(msg);
});
G__64766.cljs$core$IFn$_invoke$arity$variadic = G__64766__delegate;
return G__64766;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__64359){
var vec__64365 = p__64359;
...
var vec__64369 = first__64367;
var seq__64370 = cljs.core.seq(vec__64369);
var first__64371 = cljs.core.first(seq__64370);
var seq__64370__$1 = cljs.core.next(seq__64370);
var bind = first__64371;
var first__64371__$1 = cljs.core.first(seq__64370__$1);
var seq__64370__$2 = cljs.core.next(seq__64370__$1);
var expr__$1 = first__64371__$1;
var mod_pairs = seq__64370__$2;
var vec__64372 = seq__64366__$1;
var vec__64375 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64372,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64375,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64375,(1),null);
var next_groups = vec__64372;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__64391){
var vec__64401 = p__64391;
...
var vec__64404 = first__64403;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64404,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64404,(1),null);
var pair = vec__64404;
var etc = seq__64402__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__64328__auto__","iterys__64328__auto__",-236923958,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__64329__auto__","fs__64329__auto__",479752661,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__64328__auto__","iterys__64328__auto__",-236923958,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__64329__auto__","fs__64329__auto__",479752661,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__64329__auto__","fs__64329__auto__",479752661,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__64538){
var vec__64555 = p__64538;
...
var vec__64558 = first__64557;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64558,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64558,(1),null);
var pair = vec__64558;
var etc = seq__64556__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
