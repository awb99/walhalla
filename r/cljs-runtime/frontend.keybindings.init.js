 ...
 */
frontend.keybindings.init.bind_key = (function frontend$keybindings$init$bind_key(p__44898){
var map__44899 = p__44898;
var map__44899__$1 = cljs.core.__destructure_map(map__44899);
var keybinding = map__44899__$1;
var kb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44899__$1,new cljs.core.Keyword(null,"kb","kb",1183038587));
...
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44899__$1,new cljs.core.Keyword(null,"scope","scope",-439358418));
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function frontend$keybindings$init$init_keybindings_BANG__$_iter__44916(s__44917){
return (new cljs.core.LazySeq(null,(function (){
var s__44917__$1 = s__44917;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__44917__$1);
if(temp__5804__auto__){
var s__44917__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__44917__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__44917__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__44919 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__44918 = (0);
while(true){
if((i__44918 < size__5522__auto__)){
var kb = cljs.core._nth(c__5521__auto__,i__44918);
cljs.core.chunk_append(b__44919,frontend.keybindings.init.bind_key(kb));

var G__44947 = (i__44918 + (1));
i__44918 = G__44947;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44919),frontend$keybindings$init$init_keybindings_BANG__$_iter__44916(cljs.core.chunk_rest(s__44917__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44919),null);
}
} else {
var kb = cljs.core.first(s__44917__$2);
return cljs.core.cons(frontend.keybindings.init.bind_key(kb),frontend$keybindings$init$init_keybindings_BANG__$_iter__44916(cljs.core.rest(s__44917__$2)));
}
} else {
return null;
}
