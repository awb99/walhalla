...
frontend.keybindings.init.reframe_handler = (function frontend$keybindings$init$reframe_handler(p__44938,evt){
var map__44940 = p__44938;
var map__44940__$1 = cljs.core.__destructure_map(map__44940);
var keybinding = map__44940__$1;
var kb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44940__$1,new cljs.core.Keyword(null,"kb","kb",1183038587));
...
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44940__$1,new cljs.core.Keyword(null,"scope","scope",-439358418));
 ...
 */
frontend.keybindings.init.bind_key = (function frontend$keybindings$init$bind_key(p__44958){
var map__44959 = p__44958;
var map__44959__$1 = cljs.core.__destructure_map(map__44959);
var keybinding = map__44959__$1;
var kb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44959__$1,new cljs.core.Keyword(null,"kb","kb",1183038587));
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44959__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44959__$1,new cljs.core.Keyword(null,"scope","scope",-439358418));
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function frontend$keybindings$init$init_keybindings_BANG__$_iter__44975(s__44976){
return (new cljs.core.LazySeq(null,(function (){
var s__44976__$1 = s__44976;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__44976__$1);
if(temp__5804__auto__){
var s__44976__$2 = temp__5804__auto__;
...
var kb = cljs.core._nth(c__5521__auto__,i__44977);
cljs.core.chunk_append(b__44978,frontend.keybindings.init.bind_key(kb));

var G__44994 = (i__44977 + (1));
i__44977 = G__44994;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44978),frontend$keybindings$init$init_keybindings_BANG__$_iter__44975(cljs.core.chunk_rest(s__44976__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44978),null);
}
} else {
var kb = cljs.core.first(s__44976__$2);
return cljs.core.cons(frontend.keybindings.init.bind_key(kb),frontend$keybindings$init$init_keybindings_BANG__$_iter__44975(cljs.core.rest(s__44976__$2)));
}
} else {
return null;
}
