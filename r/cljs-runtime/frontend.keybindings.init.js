...
frontend.keybindings.init.reframe_handler = (function frontend$keybindings$init$reframe_handler(p__44896,evt){
var map__44897 = p__44896;
var map__44897__$1 = cljs.core.__destructure_map(map__44897);
var keybinding = map__44897__$1;
var kb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44897__$1,new cljs.core.Keyword(null,"kb","kb",1183038587));
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44897__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44897__$1,new cljs.core.Keyword(null,"scope","scope",-439358418));
 ...
 */
frontend.keybindings.init.bind_key = (function frontend$keybindings$init$bind_key(p__44899){
var map__44900 = p__44899;
var map__44900__$1 = cljs.core.__destructure_map(map__44900);
var keybinding = map__44900__$1;
var kb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44900__$1,new cljs.core.Keyword(null,"kb","kb",1183038587));
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44900__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44900__$1,new cljs.core.Keyword(null,"scope","scope",-439358418));
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function frontend$keybindings$init$init_keybindings_BANG__$_iter__44902(s__44903){
return (new cljs.core.LazySeq(null,(function (){
var s__44903__$1 = s__44903;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__44903__$1);
if(temp__5804__auto__){
var s__44903__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__44903__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__44903__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__44905 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__44904 = (0);
while(true){
if((i__44904 < size__5522__auto__)){
var kb = cljs.core._nth(c__5521__auto__,i__44904);
cljs.core.chunk_append(b__44905,frontend.keybindings.init.bind_key(kb));

var G__44931 = (i__44904 + (1));
i__44904 = G__44931;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44905),frontend$keybindings$init$init_keybindings_BANG__$_iter__44902(cljs.core.chunk_rest(s__44903__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44905),null);
}
} else {
var kb = cljs.core.first(s__44903__$2);
return cljs.core.cons(frontend.keybindings.init.bind_key(kb),frontend$keybindings$init$init_keybindings_BANG__$_iter__44902(cljs.core.rest(s__44903__$2)));
}
} else {
return null;
}
