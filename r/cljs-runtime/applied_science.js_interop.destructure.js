...
var _STAR_js_QMARK__STAR__orig_val__68522 = applied_science.js_interop.destructure._STAR_js_QMARK__STAR_;
var _STAR_js_QMARK__STAR__temp_val__68523 = (cljs.core.truth_(new cljs.core.Keyword("js","shallow","js/shallow",1182557210).cljs$core$IFn$_invoke$arity$1(b_meta))?false:js_QMARK_);
(applied_science.js_interop.destructure._STAR_js_QMARK__STAR_ = _STAR_js_QMARK__STAR__temp_val__68523);
...
var ret = (function (){var ret = (function (){var G__68559 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(bvec__$1,gvec,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v__$1], 0));
if(js_QMARK_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(G__68559,gvec_QMARK_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","some?","cljs.core/some?",-440439360,null),null,(1),null)),(new cljs.core.List(null,gvec,null,(1),null)))))], 0));
} else {
return G__68559;
}
})();
...
var G__68813 = applied_science$js_interop$destructure$destructure_$_pb(ret,cljs.core.second(bs),get_rest(n));
var G__68814 = n;
var G__68815 = cljs.core.nnext(bs);
var G__68816 = true;
ret = G__68813;
n = G__68814;
bs = G__68815;
seen_rest_QMARK_ = G__68816;
continue;
} else {
...
var ret = ((function (gmap,defaults,pvec,_STAR_js_QMARK__STAR__orig_val__68522,_STAR_js_QMARK__STAR__temp_val__68523,b_meta,js_QMARK_,bents){
return (function (ret){
...
});})(gmap,defaults,pvec,_STAR_js_QMARK__STAR__orig_val__68522,_STAR_js_QMARK__STAR__temp_val__68523,b_meta,js_QMARK_,bents))
...
var bes = (function (){var transforms = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (ret,gmap,defaults,pvec,_STAR_js_QMARK__STAR__orig_val__68522,_STAR_js_QMARK__STAR__temp_val__68523,b_meta,js_QMARK_,bents){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__68500_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = mkns;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.namespace(p1__68500_SHARP_);
}
})(),cljs.core.name(p1__68500_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__68501_SHARP_){
...
return cljs.core.namespace(p1__68501_SHARP_);
}
})(),cljs.core.name(p1__68501_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
});})(ret,gmap,defaults,pvec,_STAR_js_QMARK__STAR__orig_val__68522,_STAR_js_QMARK__STAR__temp_val__68523,b_meta,js_QMARK_,bents))
,cljs.core.PersistentArrayMap.EMPTY,cljs.core.keys(b__$1));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (transforms,ret,gmap,defaults,pvec,_STAR_js_QMARK__STAR__orig_val__68522,_STAR_js_QMARK__STAR__temp_val__68523,b_meta,js_QMARK_,bents){
return (function (bes,entry){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__68502_SHARP_,p2__68503_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__68502_SHARP_,p2__68503_SHARP_,(function (){var fexpr__68660 = cljs.core.val(entry);
return (fexpr__68660.cljs$core$IFn$_invoke$arity$1 ? fexpr__68660.cljs$core$IFn$_invoke$arity$1(p2__68503_SHARP_) : fexpr__68660.call(null,p2__68503_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__68661 = cljs.core.key(entry);
return (fexpr__68661.cljs$core$IFn$_invoke$arity$1 ? fexpr__68661.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__68661.call(null,bes));
})());
});})(transforms,ret,gmap,defaults,pvec,_STAR_js_QMARK__STAR__orig_val__68522,_STAR_js_QMARK__STAR__temp_val__68523,b_meta,js_QMARK_,bents))
...
var G__68829 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):applied_science$js_interop$destructure$destructure_$_pb(ret,bb,bv));
var G__68830 = cljs.core.next(bes);
ret = G__68829;
bes = G__68830;
continue;
} else {
...
}finally {(applied_science.js_interop.destructure._STAR_js_QMARK__STAR_ = _STAR_js_QMARK__STAR__orig_val__68522);
}});
...
var temp__5802__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__68512_SHARP_){
return (cljs.core.first(p1__68512_SHARP_) instanceof cljs.core.Keyword);
}),bents));
...
return cljs.spec.alpha.unform(spec,(function (){var G__68758 = cljs.spec.alpha.conform(spec,args);
return (update_conf.cljs$core$IFn$_invoke$arity$1 ? update_conf.cljs$core$IFn$_invoke$arity$1(G__68758) : update_conf.call(null,G__68758));
})());
});
applied_science.js_interop.destructure.update_argv_PLUS_body = (function applied_science$js_interop$destructure$update_argv_PLUS_body(update_fn,p__68767){
var map__68768 = p__68767;
var map__68768__$1 = cljs.core.__destructure_map(map__68768);
var conf = map__68768__$1;
var vec__68769 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68768__$1,new cljs.core.Keyword(null,"fn-tail","fn-tail",-1818869368));
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68769,(0),null);
var update_pair = (function (conf__$1){
var body_path = (function (){var G__68776 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",-2049205669),(1)], null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__68776,new cljs.core.Keyword(null,"body","body",-2049205669));
} else {
return G__68776;
}
})();
var vec__68773 = (function (){var G__68779 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(conf__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.Keyword(null,"params","params",710516235)], null)),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(conf__$1,body_path)], null);
return (update_fn.cljs$core$IFn$_invoke$arity$1 ? update_fn.cljs$core$IFn$_invoke$arity$1(G__68779) : update_fn.call(null,G__68779));
})();
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68773,(0),null);
var body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68773,(1),null);
...
break;
case "arity-n":
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(conf,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"fn-tail","fn-tail",-1818869368),(1),new cljs.core.Keyword(null,"bodies","bodies",-1295887172)], null),(function (p1__68760_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(update_pair,p1__68760_SHARP_);
}));

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68786__$1)].join('')));

}
});
applied_science.js_interop.destructure.maybe_destructured = (function applied_science$js_interop$destructure$maybe_destructured(p__68790){
var vec__68793 = p__68790;
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68793,(0),null);
var body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68793,(1),null);
...
var G__68838 = cljs.core.next(params__$1);
var G__68839 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__68840 = lets;
params__$1 = G__68838;
new_params = G__68839;
lets = G__68840;
...
var G__68841 = cljs.core.next(params__$1);
var G__68842 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__68843 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(lets,cljs.core.first(params__$1),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([gparam], 0));
params__$1 = G__68841;
new_params = G__68842;
lets = G__68843;
continue;
...
return applied_science.js_interop.destructure.spec_reform(new cljs.core.Keyword("applied-science.js-interop.destructure","function-args","applied-science.js-interop.destructure/function-args",-755493255),args,(function (p1__68803_SHARP_){
return applied_science.js_interop.destructure.update_argv_PLUS_body(applied_science.js_interop.destructure.maybe_destructured,p1__68803_SHARP_);
}));
});
