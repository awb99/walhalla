...
var G__41632 = devtools.prefs.pref(v);
v = G__41632;
continue;
} else {
return v;
...
}catch (e41560){var _e__40508__auto__ = e41560;
return false;
}})();
...
}catch (e41567){var _e__40508__auto__ = e41567;
return false;
}})();
...
}catch (e41570){var _e__40508__auto__ = e41570;
return false;
}}
}
});
...
var vec__41584 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41584,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41584,(1),null);
...
return cljs.core.some((function (p1__41601_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41601_SHARP_);
}),template);
});
