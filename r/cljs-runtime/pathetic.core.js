...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__47739_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__47739_SHARP_),cljs.core.second(p1__47739_SHARP_));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__47740_SHARP_,p2__47741_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__47740_SHARP_,p2__47741_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__47747 = cljs.core.first(path_pieces);
switch (G__47747) {
case "":
...
var G__47749 = cljs.core.first(path_pieces);
...
var G__47755 = cljs.core.last(path_pieces);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"cwd","cwd",14056523),G__47755)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path_pieces,"..");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("..",G__47755)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path_pieces,"..");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"root","root",-448657453),G__47755)){
return path_pieces;
} else {
...
while(true){
var vec__47771 = remaining_path;
var seq__47772 = cljs.core.seq(vec__47771);
var first__47773 = cljs.core.first(seq__47772);
var seq__47772__$1 = cljs.core.next(seq__47772);
var curr = first__47773;
var remainder = seq__47772__$1;
var pred__47774 = cljs.core._EQ_;
var expr__47775 = curr;
if(cljs.core.truth_((pred__47774.cljs$core$IFn$_invoke$arity$2 ? pred__47774.cljs$core$IFn$_invoke$arity$2(null,expr__47775) : pred__47774.call(null,null,expr__47775)))){
return result;
} else {
if(cljs.core.truth_((pred__47774.cljs$core$IFn$_invoke$arity$2 ? pred__47774.cljs$core$IFn$_invoke$arity$2("",expr__47775) : pred__47774.call(null,"",expr__47775)))){
var G__47824 = result;
var G__47825 = remainder;
result = G__47824;
remaining_path = G__47825;
continue;
} else {
if(cljs.core.truth_((pred__47774.cljs$core$IFn$_invoke$arity$2 ? pred__47774.cljs$core$IFn$_invoke$arity$2(".",expr__47775) : pred__47774.call(null,".",expr__47775)))){
var G__47828 = result;
var G__47829 = remainder;
result = G__47828;
remaining_path = G__47829;
continue;
} else {
if(cljs.core.truth_((pred__47774.cljs$core$IFn$_invoke$arity$2 ? pred__47774.cljs$core$IFn$_invoke$arity$2("..",expr__47775) : pred__47774.call(null,"..",expr__47775)))){
var G__47830 = pathetic.core.up_dir(result);
var G__47831 = remainder;
result = G__47830;
remaining_path = G__47831;
continue;
} else {
var G__47835 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,curr);
var G__47836 = remainder;
result = G__47835;
remaining_path = G__47836;
continue;
}
}
}
...
var pred__47785 = cljs.core._EQ_;
var expr__47786 = curr;
if(cljs.core.truth_((pred__47785.cljs$core$IFn$_invoke$arity$2 ? pred__47785.cljs$core$IFn$_invoke$arity$2(null,expr__47786) : pred__47785.call(null,null,expr__47786)))){
return suffix;
} else {
if(cljs.core.truth_((pred__47785.cljs$core$IFn$_invoke$arity$2 ? pred__47785.cljs$core$IFn$_invoke$arity$2("",expr__47786) : pred__47785.call(null,"",expr__47786)))){
var G__47838 = suffix;
var G__47839 = cljs.core.rest(remainder);
suffix = G__47838;
remainder = G__47839;
continue;
} else {
if(cljs.core.truth_((pred__47785.cljs$core$IFn$_invoke$arity$2 ? pred__47785.cljs$core$IFn$_invoke$arity$2(".",expr__47786) : pred__47785.call(null,".",expr__47786)))){
var G__47840 = suffix;
var G__47841 = cljs.core.rest(remainder);
suffix = G__47840;
remainder = G__47841;
continue;
} else {
if(cljs.core.truth_((pred__47785.cljs$core$IFn$_invoke$arity$2 ? pred__47785.cljs$core$IFn$_invoke$arity$2("..",expr__47786) : pred__47785.call(null,"..",expr__47786)))){
var G__47842 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(suffix,"..");
var G__47843 = cljs.core.rest(remainder);
suffix = G__47842;
remainder = G__47843;
continue;
} else {
var G__47844 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(suffix,curr);
var G__47845 = cljs.core.rest(remainder);
suffix = G__47844;
remainder = G__47845;
continue;
}
...
var vec__47799 = pathetic.core.split_url_on_path(url_or_string);
var pre_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47799,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47799,(1),null);
var post_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47799,(2),null);
...
var vec__47807 = pathetic.core.split_url_on_path(url_or_string);
var pre_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47807,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47807,(1),null);
var post_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47807,(2),null);
