...
var periods__$1 = cljs.core.vec((function (){var G__57569 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57563_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__57563_SHARP_,(0),(3));
}),G__57569);
} else {
return G__57569;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__57614){
var vec__57615 = p__57614;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57615,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57615,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__57618 = pattern;
switch (G__57618) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57618)].join('')));
...
switch (G__57630__$1) {
case "millis":
return (function (p1__57622_SHARP_){
return p1__57622_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__57623_SHARP_){
return p1__57623_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__57624_SHARP_){
return p1__57624_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__57625_SHARP_){
return p1__57625_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__57626_SHARP_){
return p1__57626_SHARP_.getHours();
});

break;
case "day":
return (function (p1__57627_SHARP_){
return p1__57627_SHARP_.getDate();
});

break;
case "month":
return (function (p1__57628_SHARP_){
return p1__57628_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__57629_SHARP_){
return p1__57629_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__57636){
var vec__57637 = p__57636;
var seq__57638 = cljs.core.seq(vec__57637);
var first__57639 = cljs.core.first(seq__57638);
var seq__57638__$1 = cljs.core.next(seq__57638);
var key = first__57639;
var args = seq__57638__$1;
var G__57641 = key;
...
break;
case "ordinal-suffix":
var vec__57644 = (function (){var G__57647 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__57647) : syntax_list.call(null,G__57647));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57641__$1)].join('')));
...
var d = value;
var G__57652 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__57654 = G__57652;
var seq__57655 = cljs.core.seq(vec__57654);
var first__57656 = cljs.core.first(seq__57655);
var seq__57655__$1 = cljs.core.next(seq__57655);
var unparser = first__57656;
var more = seq__57655__$1;
var s = "";
var d__$1 = d;
var G__57652__$1 = G__57652;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__57664 = G__57652__$1;
var seq__57665 = cljs.core.seq(vec__57664);
var first__57666 = cljs.core.first(seq__57665);
var seq__57665__$1 = cljs.core.next(seq__57665);
var unparser__$1 = first__57666;
var more__$1 = seq__57665__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__57667 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57667,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57667,(1),null);
var G__57795 = d__$3;
var G__57796 = more__$1;
var G__57797 = s__$3;
d__$1 = G__57795;
G__57652__$1 = G__57796;
s__$1 = G__57797;
continue;
}
break;
