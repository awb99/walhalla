...
if((c === "\n")){
var G__71154 = escape_QMARK_;
var G__71155 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__71154;
lines = G__71155;
continue;
} else {
buf.append(c);

var G__71156 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__71157 = lines;
escape_QMARK_ = G__71156;
lines = G__71157;
continue;
...
var G__71149 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__71149) : rewrite_clj.node.string_node.call(null,G__71149));
});
...
var G__71150 = cljs.core.re_pattern(regex);
var G__71151 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__71150,G__71151) : rewrite_clj.node.token_node.call(null,G__71150,G__71151));
});
