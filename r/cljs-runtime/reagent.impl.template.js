...
var G__43112 = o;
reagent.impl.template.goog$module$goog$object.set(G__43112,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__43372__delegate = function (args){
...
while (G__43373__i < G__43373__a.length) {G__43373__a[G__43373__i] = arguments[G__43373__i + 0]; ++G__43373__i;}
  args = new cljs.core.IndexedSeq(G__43373__a,0,null);
} 
return G__43372__delegate.call(this,args);};
G__43372.cljs$lang$maxFixedArity = 0;
G__43372.cljs$lang$applyTo = (function (arglist__43374){
var args = cljs.core.seq(arglist__43374);
return G__43372__delegate(args);
});
...
var G__43119 = o;
reagent.impl.template.goog$module$goog$object.set(G__43119,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__43381__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__43381__delegate.call(this,args);};
...
return G__43381__delegate(args);
});
...
var G__43132 = props;
var G__43132__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43132,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43132);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43132__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__43134 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43134,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__43134;
}
})(),id_class);
...
var G__43140 = (cljs.core.count(argv) - first_child);
switch (G__43140) {
case (0):
...
var vec__43144 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43144,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43144,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43144,(2),null);
...
var temp__5808__auto___43390 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___43390 == null)){
} else {
var key_43391 = temp__5808__auto___43390;
(jsprops.key = key_43391);
}
...
var temp__5808__auto___43395 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___43395 == null)){
} else {
var key_43396 = temp__5808__auto___43395;
(jsprops.key = key_43396);
}
...
var temp__5808__auto___43397 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___43397 == null)){
} else {
var key_43398 = temp__5808__auto___43397;
(jsprops.key = key_43398);
}
...
var temp__5808__auto___43414 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___43414 == null)){
} else {
var key_43416 = temp__5808__auto___43414;
(jsprops.key = key_43416);
}
...
var temp__5808__auto___43423 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___43423 == null)){
} else {
var key_43424 = temp__5808__auto___43423;
(jsprops.key = key_43424);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43259_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__43259_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__43275 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43275,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43275,(1),null);
...
break;
default:
var G__43438 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__43439 = compiler;
v = G__43438;
compiler = G__43439;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template43324 = (function (opts,id,fn_to_element,parse_fn,meta43325){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta43325 = meta43325;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template43324.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43326,meta43325__$1){
var self__ = this;
var _43326__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template43324(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta43325__$1));
}));

(reagent.impl.template.t_reagent$impl$template43324.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43326){
var self__ = this;
var _43326__$1 = this;
return self__.meta43325;
}));

(reagent.impl.template.t_reagent$impl$template43324.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template43324.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template43324.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template43324.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template43324.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template43324.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta43325","meta43325",-308787561,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template43324.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template43324.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template43324");

(reagent.impl.template.t_reagent$impl$template43324.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template43324");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template43324.
 */
reagent.impl.template.__GT_t_reagent$impl$template43324 = (function reagent$impl$template$__GT_t_reagent$impl$template43324(opts,id,fn_to_element,parse_fn,meta43325){
return (new reagent.impl.template.t_reagent$impl$template43324(opts,id,fn_to_element,parse_fn,meta43325));
});
...
return (new reagent.impl.template.t_reagent$impl$template43324(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
