...
var G__47616 = request;
var G__47617 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__47616,G__47617) : ajax.formats.get_format.call(null,G__47616,G__47617));
} else {
...
return cljs.core.some((function (p1__47633_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__47633_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__47688){
var map__47689 = p__47688;
var map__47689__$1 = cljs.core.__destructure_map(map__47689);
var request = map__47689__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47689__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__47723 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__47723.cljs$core$IFn$_invoke$arity$1 ? fexpr__47723.cljs$core$IFn$_invoke$arity$1(response) : fexpr__47723.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__47728){
var map__47729 = p__47728;
var map__47729__$1 = cljs.core.__destructure_map(map__47729);
var request = map__47729__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47729__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__47724_SHARP_){
return ajax.formats.get_accept_entries(request,p1__47724_SHARP_);
