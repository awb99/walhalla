...
var G__72470 = (function (){var G__72471 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__72471) : f.call(null,G__72471));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__72470) : rewrite_clj.node.coerce.call(null,G__72470));
});
/**
...
var len__5769__auto___72542 = arguments.length;
var i__5770__auto___72543 = (0);
while(true){
if((i__5770__auto___72543 < len__5769__auto___72542)){
args__5775__auto__.push((arguments[i__5770__auto___72543]));

var G__72545 = (i__5770__auto___72543 + (1));
i__5770__auto___72543 = G__72545;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__72476_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__72476_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq72478){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__72479,G__72480,seq72478__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__72505 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__72505) : str_fn.call(null,G__72505));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__72507 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__72507) : str_fn.call(null,G__72507));
})()):null)));
...
var G__72519 = rewrite_clj.zip.base.tag(zloc);
var G__72519__$1 = (((G__72519 instanceof cljs.core.Keyword))?G__72519.fqn:null);
switch (G__72519__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__72514_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__72514_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__72516_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__72516_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__72519__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__72537 = rewrite_clj.zip.base.tag(zloc);
var G__72537__$1 = (((G__72537 instanceof cljs.core.Keyword))?G__72537.fqn:null);
switch (G__72537__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__72529_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__72529_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__72537__$1)].join('')));
