...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k70544,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__70569 = k70544;
var G__70569__$1 = (((G__70569 instanceof cljs.core.Keyword))?G__70569.fqn:null);
switch (G__70569__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k70544,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__70579){
var vec__70580 = p__70579;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70580,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70580,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__70542){
var self__ = this;
var G__70542__$1 = this;
return (new cljs.core.RecordIter((0),G__70542__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this70548,other70549){
var self__ = this;
var this70548__$1 = this;
return (((!((other70549 == null)))) && ((((this70548__$1.constructor === other70549.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70548__$1.tag,other70549.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70548__$1.wrap_fn,other70549.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70548__$1.wrap_length,other70549.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70548__$1.seq_fn,other70549.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70548__$1.children,other70549.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70548__$1.__extmap,other70549.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__70614 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__70614) : self__.seq_fn.call(null,G__70614));
}));
...
var self__ = this;
var this$__$1 = this;
var G__70627 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__70627) : self__.wrap_fn.call(null,G__70627));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k70544){
var self__ = this;
var this__5350__auto____$1 = this;
var G__70649 = k70544;
var G__70649__$1 = (((G__70649 instanceof cljs.core.Keyword))?G__70649.fqn:null);
switch (G__70649__$1) {
case "tag":
case "wrap-fn":
case "wrap-length":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k70544);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__70542){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__70655 = cljs.core.keyword_identical_QMARK_;
var expr__70656 = k__5352__auto__;
if(cljs.core.truth_((pred__70655.cljs$core$IFn$_invoke$arity$2 ? pred__70655.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__70656) : pred__70655.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__70656)))){
return (new rewrite_clj.node.seq.SeqNode(G__70542,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__70655.cljs$core$IFn$_invoke$arity$2 ? pred__70655.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__70656) : pred__70655.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__70656)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__70542,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__70655.cljs$core$IFn$_invoke$arity$2 ? pred__70655.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__70656) : pred__70655.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__70656)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__70542,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__70655.cljs$core$IFn$_invoke$arity$2 ? pred__70655.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__70656) : pred__70655.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__70656)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__70542,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__70655.cljs$core$IFn$_invoke$arity$2 ? pred__70655.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__70656) : pred__70655.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__70656)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__70542,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__70542),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__70542){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__70542,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__70550){
var extmap__5385__auto__ = (function (){var G__70694 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__70550,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__70550)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__70694);
} else {
return G__70694;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__70550),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__70550),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__70550),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__70550),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__70550),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__70697_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__70697_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__70719_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__70719_SHARP_);
}),children);
});
