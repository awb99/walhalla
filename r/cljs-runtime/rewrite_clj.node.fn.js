...
var syms = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__70447(s__70448){
return (new cljs.core.LazySeq(null,(function (){
var s__70448__$1 = s__70448;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__70448__$1);
if(temp__5804__auto__){
var s__70448__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70448__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__70448__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__70450 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__70449 = (0);
while(true){
if((i__70449 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__70449);
...
cljs.core.chunk_append(b__70450,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__70683 = (i__70449 + (1));
i__70449 = G__70683;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70450),rewrite_clj$node$fn$fn_walk_$_iter__70447(cljs.core.chunk_rest(s__70448__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70450),null);
}
} else {
var i = cljs.core.first(s__70448__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__70447(cljs.core.rest(s__70448__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__70441_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__70441_SHARP_);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return p1__70441_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k70473,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__70499 = k70473;
var G__70499__$1 = (((G__70499 instanceof cljs.core.Keyword))?G__70499.fqn:null);
switch (G__70499__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k70473,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__70507){
var vec__70508 = p__70507;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70508,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70508,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__70472){
var self__ = this;
var G__70472__$1 = this;
return (new cljs.core.RecordIter((0),G__70472__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this70474,other70475){
var self__ = this;
var this70474__$1 = this;
return (((!((other70475 == null)))) && ((((this70474__$1.constructor === other70475.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70474__$1.children,other70475.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70474__$1.__extmap,other70475.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k70473){
var self__ = this;
var this__5350__auto____$1 = this;
var G__70593 = k70473;
var G__70593__$1 = (((G__70593 instanceof cljs.core.Keyword))?G__70593.fqn:null);
switch (G__70593__$1) {
case "children":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k70473);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__70472){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__70595 = cljs.core.keyword_identical_QMARK_;
var expr__70596 = k__5352__auto__;
if(cljs.core.truth_((pred__70595.cljs$core$IFn$_invoke$arity$2 ? pred__70595.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__70596) : pred__70595.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__70596)))){
return (new rewrite_clj.node.fn.FnNode(G__70472,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__70472),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__70472){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__70472,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__70479){
var extmap__5385__auto__ = (function (){var G__70630 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__70479,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__70479)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__70630);
} else {
return G__70630;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__70479),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
