...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k70038,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__70091 = k70038;
var G__70091__$1 = (((G__70091 instanceof cljs.core.Keyword))?G__70091.fqn:null);
switch (G__70091__$1) {
case "whitespace":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k70038,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__70108){
var vec__70112 = p__70108;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70112,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70112,(1),null);
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__70037){
var self__ = this;
var G__70037__$1 = this;
return (new cljs.core.RecordIter((0),G__70037__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this70039,other70040){
var self__ = this;
var this70039__$1 = this;
return (((!((other70040 == null)))) && ((((this70039__$1.constructor === other70040.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70039__$1.whitespace,other70040.whitespace)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70039__$1.__extmap,other70040.__extmap)))))));
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k70038){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k70038);

}
}));

(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__70037){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__70189 = cljs.core.keyword_identical_QMARK_;
var expr__70190 = k__5352__auto__;
if(cljs.core.truth_((pred__70189.cljs$core$IFn$_invoke$arity$2 ? pred__70189.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__70190) : pred__70189.call(null,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__70190)))){
return (new rewrite_clj.node.whitespace.WhitespaceNode(G__70037,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__70037),null));
}
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__70037){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,G__70037,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.whitespace.map__GT_WhitespaceNode = (function rewrite_clj$node$whitespace$map__GT_WhitespaceNode(G__70050){
var extmap__5385__auto__ = (function (){var G__70214 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__70050,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483));
if(cljs.core.record_QMARK_(G__70050)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__70214);
} else {
return G__70214;
}
})();
return (new rewrite_clj.node.whitespace.WhitespaceNode(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483).cljs$core$IFn$_invoke$arity$1(G__70050),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k70221,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__70262 = k70221;
var G__70262__$1 = (((G__70262 instanceof cljs.core.Keyword))?G__70262.fqn:null);
switch (G__70262__$1) {
case "newlines":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k70221,else__5346__auto__);
...
var self__ = this;
var this__5363__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__70265){
var vec__70266 = p__70265;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70266,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70266,(1),null);
return (f__5364__auto__.cljs$core$IFn$_invoke$arity$3 ? f__5364__auto__.cljs$core$IFn$_invoke$arity$3(ret__5366__auto__,k__5367__auto__,v__5368__auto__) : f__5364__auto__.call(null,ret__5366__auto__,k__5367__auto__,v__5368__auto__));
}),init__5365__auto__,this__5363__auto____$1);
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__70220){
var self__ = this;
var G__70220__$1 = this;
return (new cljs.core.RecordIter((0),G__70220__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"newlines","newlines",-1185451518)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this70222,other70223){
var self__ = this;
var this70222__$1 = this;
return (((!((other70223 == null)))) && ((((this70222__$1.constructor === other70223.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70222__$1.newlines,other70223.newlines)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this70222__$1.__extmap,other70223.__extmap)))))));
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k70221){
var self__ = this;
var this__5350__auto____$1 = this;
var G__70332 = k70221;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k70221);

}
}));

(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__70220){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__70336 = cljs.core.keyword_identical_QMARK_;
var expr__70337 = k__5352__auto__;
if(cljs.core.truth_((pred__70336.cljs$core$IFn$_invoke$arity$2 ? pred__70336.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__70337) : pred__70336.call(null,new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__70337)))){
return (new rewrite_clj.node.whitespace.NewlineNode(G__70220,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__70220),null));
}
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__70220){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,G__70220,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.whitespace.map__GT_NewlineNode = (function rewrite_clj$node$whitespace$map__GT_NewlineNode(G__70235){
var extmap__5385__auto__ = (function (){var G__70372 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__70235,new cljs.core.Keyword(null,"newlines","newlines",-1185451518));
if(cljs.core.record_QMARK_(G__70235)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__70372);
} else {
return G__70372;
}
})();
return (new rewrite_clj.node.whitespace.NewlineNode(new cljs.core.Keyword(null,"newlines","newlines",-1185451518).cljs$core$IFn$_invoke$arity$1(G__70235),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var comma_70486 = rewrite_clj.node.whitespace.whitespace_node(", ");
/**
...
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(comma_70486)));
});
var nl_70487 = rewrite_clj.node.whitespace.newline_node("\n");
/**
...
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(nl_70487)));
});
var space_70488 = rewrite_clj.node.whitespace.whitespace_node(" ");
/**
 * Interleave the given seq of nodes with `" "` nodes.
 */
rewrite_clj.node.whitespace.space_separated = (function rewrite_clj$node$whitespace$space_separated(nodes){
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(space_70488)));
});
/**
