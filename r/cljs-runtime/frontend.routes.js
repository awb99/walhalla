...
frontend.routes.route__GT_url = (function frontend$routes$route__GT_url(p__44924){
var map__44925 = p__44924;
var map__44925__$1 = cljs.core.__destructure_map(map__44925);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44925__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44925__$1,new cljs.core.Keyword(null,"query-params","query-params",900640534));
var route_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44925__$1,new cljs.core.Keyword(null,"route-params","route-params",2111411055));
...
var map__44931 = cemerick.url.url.cljs$core$IFn$_invoke$arity$1(path_with_qp);
var map__44931__$1 = cljs.core.__destructure_map(map__44931);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44931__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44931__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var query_params = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__44932){
var vec__44933 = p__44932;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44933,(0),null);
...
var map__44936 = match;
var map__44936__$1 = cljs.core.__destructure_map(map__44936);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44936__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var route_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44936__$1,new cljs.core.Keyword(null,"route-params","route-params",2111411055));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44936__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__44942 = new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(match);
return (frontend.routes.hard_redirect.cljs$core$IFn$_invoke$arity$1 ? frontend.routes.hard_redirect.cljs$core$IFn$_invoke$arity$1(G__44942) : frontend.routes.hard_redirect.call(null,G__44942));
} else {
return null;
}
});
...
var len__5769__auto___45042 = arguments.length;
var i__5770__auto___45043 = (0);
while(true){
if((i__5770__auto___45043 < len__5769__auto___45042)){
args__5775__auto__.push((arguments[i__5770__auto___45043]));

var G__45044 = (i__5770__auto___45043 + (1));
i__5770__auto___45043 = G__45044;
continue;
} else {
}
break;
...
/** @this {Function} */
(frontend.routes.on_url_change.cljs$lang$applyTo = (function (seq44950){
var G__44951 = cljs.core.first(seq44950);
var seq44950__$1 = cljs.core.next(seq44950);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44951,seq44950__$1);
}));
...
/** @this {Function} */
(frontend.routes.goto_BANG_.cljs$lang$applyTo = (function (seq44984){
var G__44985 = cljs.core.first(seq44984);
var seq44984__$1 = cljs.core.next(seq44984);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44985,seq44984__$1);
}));

frontend.routes.nav_BANG_ = (function frontend$routes$nav_BANG_(url){
var map__44998 = frontend.routes.path__GT_route(cljs.core.deref(frontend.routes.routes),url,cljs.core.PersistentArrayMap.EMPTY);
var map__44998__$1 = cljs.core.__destructure_map(map__44998);
var h = map__44998__$1;
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44998__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
