...
frontend.routes.route__GT_url = (function frontend$routes$route__GT_url(p__44739){
var map__44740 = p__44739;
var map__44740__$1 = cljs.core.__destructure_map(map__44740);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44740__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44740__$1,new cljs.core.Keyword(null,"query-params","query-params",900640534));
var route_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44740__$1,new cljs.core.Keyword(null,"route-params","route-params",2111411055));
...
var map__44756 = cemerick.url.url.cljs$core$IFn$_invoke$arity$1(path_with_qp);
var map__44756__$1 = cljs.core.__destructure_map(map__44756);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44756__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44756__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var query_params = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__44760){
var vec__44762 = p__44760;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44762,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44762,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),v], null);
}),query));
var match = bidi.bidi.match_route_STAR_(routes,path,options);
if(cljs.core.truth_(match)){
var map__44767 = match;
var map__44767__$1 = cljs.core.__destructure_map(map__44767);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44767__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var route_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44767__$1,new cljs.core.Keyword(null,"route-params","route-params",2111411055));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44767__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__44779 = new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(match);
return (frontend.routes.hard_redirect.cljs$core$IFn$_invoke$arity$1 ? frontend.routes.hard_redirect.cljs$core$IFn$_invoke$arity$1(G__44779) : frontend.routes.hard_redirect.call(null,G__44779));
} else {
return null;
}
});
...
var len__5769__auto___44934 = arguments.length;
var i__5770__auto___44935 = (0);
while(true){
if((i__5770__auto___44935 < len__5769__auto___44934)){
args__5775__auto__.push((arguments[i__5770__auto___44935]));

var G__44936 = (i__5770__auto___44935 + (1));
i__5770__auto___44935 = G__44936;
continue;
} else {
}
break;
...
/** @this {Function} */
(frontend.routes.on_url_change.cljs$lang$applyTo = (function (seq44784){
var G__44785 = cljs.core.first(seq44784);
var seq44784__$1 = cljs.core.next(seq44784);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44785,seq44784__$1);
}));
...
var add = (function (m,p__44803){
var vec__44804 = p__44803;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44804,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44804,(1),null);
...
var args__5775__auto__ = [];
var len__5769__auto___44960 = arguments.length;
var i__5770__auto___44961 = (0);
while(true){
if((i__5770__auto___44961 < len__5769__auto___44960)){
args__5775__auto__.push((arguments[i__5770__auto___44961]));

var G__44962 = (i__5770__auto___44961 + (1));
i__5770__auto___44961 = G__44962;
continue;
} else {
}
break;
...
/** @this {Function} */
(frontend.routes.goto_BANG_.cljs$lang$applyTo = (function (seq44812){
var G__44813 = cljs.core.first(seq44812);
var seq44812__$1 = cljs.core.next(seq44812);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44813,seq44812__$1);
}));

frontend.routes.nav_BANG_ = (function frontend$routes$nav_BANG_(url){
var map__44819 = frontend.routes.path__GT_route(cljs.core.deref(frontend.routes.routes),url,cljs.core.PersistentArrayMap.EMPTY);
var map__44819__$1 = cljs.core.__destructure_map(map__44819);
var h = map__44819__$1;
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44819__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
frontend.routes.init_BANG_ = (function frontend$routes$init_BANG_(routes_frontend){
...
return frontend.routes.history.pushy$core$IHistory$start_BANG_$arity$1(null);
});
frontend.routes.G = (function frontend$routes$G(handler_str){
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"frontend.routes",null,187,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"frontend.routes",null,189,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
