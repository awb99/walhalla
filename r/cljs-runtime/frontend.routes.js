...
frontend.routes.route__GT_url = (function frontend$routes$route__GT_url(p__44939){
var map__44940 = p__44939;
var map__44940__$1 = cljs.core.__destructure_map(map__44940);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44940__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44940__$1,new cljs.core.Keyword(null,"query-params","query-params",900640534));
var route_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44940__$1,new cljs.core.Keyword(null,"route-params","route-params",2111411055));
...
var map__44952 = cemerick.url.url.cljs$core$IFn$_invoke$arity$1(path_with_qp);
var map__44952__$1 = cljs.core.__destructure_map(map__44952);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44952__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44952__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var query_params = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__44953){
...
var map__44957 = match;
var map__44957__$1 = cljs.core.__destructure_map(map__44957);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44957__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var route_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44957__$1,new cljs.core.Keyword(null,"route-params","route-params",2111411055));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44957__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__44958 = new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(match);
return (frontend.routes.hard_redirect.cljs$core$IFn$_invoke$arity$1 ? frontend.routes.hard_redirect.cljs$core$IFn$_invoke$arity$1(G__44958) : frontend.routes.hard_redirect.call(null,G__44958));
} else {
return null;
}
});
...
var len__5769__auto___45114 = arguments.length;
var i__5770__auto___45115 = (0);
while(true){
if((i__5770__auto___45115 < len__5769__auto___45114)){
args__5775__auto__.push((arguments[i__5770__auto___45115]));

var G__45116 = (i__5770__auto___45115 + (1));
i__5770__auto___45115 = G__45116;
continue;
} else {
}
break;
...
/** @this {Function} */
(frontend.routes.on_url_change.cljs$lang$applyTo = (function (seq44963){
var G__44964 = cljs.core.first(seq44963);
var seq44963__$1 = cljs.core.next(seq44963);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44964,seq44963__$1);
}));
...
var add = (function (m,p__45033){
var vec__45034 = p__45033;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45034,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45034,(1),null);
...
var args__5775__auto__ = [];
var len__5769__auto___45118 = arguments.length;
var i__5770__auto___45119 = (0);
while(true){
if((i__5770__auto___45119 < len__5769__auto___45118)){
args__5775__auto__.push((arguments[i__5770__auto___45119]));

var G__45120 = (i__5770__auto___45119 + (1));
i__5770__auto___45119 = G__45120;
continue;
} else {
}
break;
...
/** @this {Function} */
(frontend.routes.goto_BANG_.cljs$lang$applyTo = (function (seq45053){
var G__45054 = cljs.core.first(seq45053);
var seq45053__$1 = cljs.core.next(seq45053);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45054,seq45053__$1);
}));

frontend.routes.nav_BANG_ = (function frontend$routes$nav_BANG_(url){
var map__45057 = frontend.routes.path__GT_route(cljs.core.deref(frontend.routes.routes),url,cljs.core.PersistentArrayMap.EMPTY);
var map__45057__$1 = cljs.core.__destructure_map(map__45057);
var h = map__45057__$1;
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45057__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
