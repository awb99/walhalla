...
frontend.routes.route__GT_url = (function frontend$routes$route__GT_url(p__41515){
var map__41516 = p__41515;
var map__41516__$1 = cljs.core.__destructure_map(map__41516);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41516__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41516__$1,new cljs.core.Keyword(null,"query-params","query-params",900640534));
var route_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41516__$1,new cljs.core.Keyword(null,"route-params","route-params",2111411055));
...
var map__41527 = cemerick.url.url.cljs$core$IFn$_invoke$arity$1(path_with_qp);
var map__41527__$1 = cljs.core.__destructure_map(map__41527);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41527__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41527__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var query_params = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__41530){
var vec__41531 = p__41530;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41531,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41531,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),v], null);
}),query));
var match = bidi.bidi.match_route_STAR_(routes,path,options);
if(cljs.core.truth_(match)){
var map__41534 = match;
var map__41534__$1 = cljs.core.__destructure_map(map__41534);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41534__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var route_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41534__$1,new cljs.core.Keyword(null,"route-params","route-params",2111411055));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41534__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__41547 = new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(match);
return (frontend.routes.hard_redirect.cljs$core$IFn$_invoke$arity$1 ? frontend.routes.hard_redirect.cljs$core$IFn$_invoke$arity$1(G__41547) : frontend.routes.hard_redirect.call(null,G__41547));
} else {
return null;
}
});
...
var i__5770__auto___41788 = (0);
while(true){
if((i__5770__auto___41788 < len__5769__auto___41786)){
args__5775__auto__.push((arguments[i__5770__auto___41788]));

var G__41790 = (i__5770__auto___41788 + (1));
i__5770__auto___41788 = G__41790;
continue;
} else {
}
break;
...
/** @this {Function} */
(frontend.routes.on_url_change.cljs$lang$applyTo = (function (seq41563){
var G__41578 = cljs.core.first(seq41563);
var seq41563__$1 = cljs.core.next(seq41563);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41578,seq41563__$1);
}));
...
var add = (function (m,p__41675){
var vec__41678 = p__41675;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41678,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41678,(1),null);
...
var args__5775__auto__ = [];
var len__5769__auto___41819 = arguments.length;
var i__5770__auto___41820 = (0);
while(true){
if((i__5770__auto___41820 < len__5769__auto___41819)){
args__5775__auto__.push((arguments[i__5770__auto___41820]));

var G__41822 = (i__5770__auto___41820 + (1));
i__5770__auto___41820 = G__41822;
continue;
} else {
}
break;
...
/** @this {Function} */
(frontend.routes.goto_BANG_.cljs$lang$applyTo = (function (seq41692){
var G__41693 = cljs.core.first(seq41692);
var seq41692__$1 = cljs.core.next(seq41692);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41693,seq41692__$1);
}));

frontend.routes.nav_BANG_ = (function frontend$routes$nav_BANG_(url){
var map__41712 = frontend.routes.path__GT_route(cljs.core.deref(frontend.routes.routes),url,cljs.core.PersistentArrayMap.EMPTY);
var map__41712__$1 = cljs.core.__destructure_map(map__41712);
var h = map__41712__$1;
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41712__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
