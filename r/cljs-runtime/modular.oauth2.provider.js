...
var map__39900 = modular.oauth2.provider.full_provider_config(config,provider);
var map__39900__$1 = cljs.core.__destructure_map(map__39900);
var authorize_uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39900__$1,new cljs.core.Keyword(null,"authorize-uri","authorize-uri",1296259534));
var client_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39900__$1,new cljs.core.Keyword(null,"client-id","client-id",-464622140));
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39900__$1,new cljs.core.Keyword(null,"scope","scope",-439358418));
var authorize_query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39900__$1,new cljs.core.Keyword(null,"authorize-query-params","authorize-query-params",2017344958));
var authorize_nonce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39900__$1,new cljs.core.Keyword(null,"authorize-nonce","authorize-nonce",-957663765));
var authorize_redirect_uri_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39900__$1,new cljs.core.Keyword(null,"authorize-redirect-uri-name","authorize-redirect-uri-name",1553957341));
