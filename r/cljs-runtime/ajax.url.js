...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__46711){
...
var vec_key_encode = (function (){var G__46737 = (function (){var or__5045__auto__ = vec_strategy;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46737__$1)].join('')));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__46748){
var vec__46749 = p__46748;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46749,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46749,(1),null);
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__46787){
var map__46788 = p__46787;
var map__46788__$1 = cljs.core.__destructure_map(map__46788);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46788__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
