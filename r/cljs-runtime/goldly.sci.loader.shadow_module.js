...
var l = uri.length();
var iter__5523__auto__ = (function goldly$sci$loader$shadow_module$patch_url_$_iter__54554(s__54555){
return (new cljs.core.LazySeq(null,(function (){
var s__54555__$1 = s__54555;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__54555__$1);
if(temp__5804__auto__){
var s__54555__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54555__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__54555__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__54557 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__54556 = (0);
while(true){
if((i__54556 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__54556);
cljs.core.chunk_append(b__54557,(function (){var el = (uri[i]);
return (uri[i] = [base,cljs.core.str.cljs$core$IFn$_invoke$arity$1(el)].join(''));
})());

var G__54563 = (i__54556 + (1));
i__54556 = G__54563;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54557),goldly$sci$loader$shadow_module$patch_url_$_iter__54554(cljs.core.chunk_rest(s__54555__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54557),null);
}
} else {
var i = cljs.core.first(s__54555__$2);
return cljs.core.cons((function (){var el = (uri[i]);
return (uri[i] = [base,cljs.core.str.cljs$core$IFn$_invoke$arity$1(el)].join(''));
})(),goldly$sci$loader$shadow_module$patch_url_$_iter__54554(cljs.core.rest(s__54555__$2)));
}
} else {
return null;
}
...
return iter__5523__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$2((0),l));
});
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"debug","debug",-1608172596),"goldly.sci.loader.shadow-module",null,47,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"goldly.sci.loader.shadow-module",null,51,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"goldly.sci.loader.shadow-module",null,55,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"goldly.sci.loader.shadow-module",null,62,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"goldly.sci.loader.shadow-module",null,67,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"goldly.sci.loader.shadow-module",null,74,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"goldly.sci.loader.shadow-module",null,78,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["load-module: ",libname], null);
}),null)),null,(94),null);

var promises = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54558){
var vec__54559 = p__54558;
var sci_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54559,(0),null);
var map__54562 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54559,(1),null);
var map__54562__$1 = cljs.core.__destructure_map(map__54562);
var sci_def = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54562__$1,new cljs.core.Keyword(null,"sci-def","sci-def",-971575708));
var loadable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54562__$1,new cljs.core.Keyword(null,"loadable","loadable",-411421563));
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"goldly.sci.loader.shadow-module",null,86,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
