...
var l = uri.length;
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function goldly$sci$loader$shadow_module$patch_url_$_iter__54590(s__54591){
return (new cljs.core.LazySeq(null,(function (){
var s__54591__$1 = s__54591;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__54591__$1);
if(temp__5804__auto__){
var s__54591__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54591__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__54591__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__54593 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__54592 = (0);
while(true){
if((i__54592 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__54592);
cljs.core.chunk_append(b__54593,(function (){var el = (uri[i]);
return (uri[i] = [base,cljs.core.str.cljs$core$IFn$_invoke$arity$1(el)].join(''));
})());

var G__54599 = (i__54592 + (1));
i__54592 = G__54599;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54593),goldly$sci$loader$shadow_module$patch_url_$_iter__54590(cljs.core.chunk_rest(s__54591__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54593),null);
}
} else {
var i = cljs.core.first(s__54591__$2);
return cljs.core.cons((function (){var el = (uri[i]);
return (uri[i] = [base,cljs.core.str.cljs$core$IFn$_invoke$arity$1(el)].join(''));
})(),goldly$sci$loader$shadow_module$patch_url_$_iter__54590(cljs.core.rest(s__54591__$2)));
}
} else {
return null;
}
...
var promises = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54594){
var vec__54595 = p__54594;
var sci_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54595,(0),null);
var map__54598 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54595,(1),null);
var map__54598__$1 = cljs.core.__destructure_map(map__54598);
var sci_def = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54598__$1,new cljs.core.Keyword(null,"sci-def","sci-def",-971575708));
var loadable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54598__$1,new cljs.core.Keyword(null,"loadable","loadable",-411421563));
