...
var l = uri.length;
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function goldly$sci$loader$shadow_module$patch_url_$_iter__54629(s__54630){
return (new cljs.core.LazySeq(null,(function (){
var s__54630__$1 = s__54630;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__54630__$1);
if(temp__5804__auto__){
var s__54630__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54630__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__54630__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__54632 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__54631 = (0);
while(true){
if((i__54631 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__54631);
cljs.core.chunk_append(b__54632,(function (){var el = (uri[i]);
return (uri[i] = [base,cljs.core.str.cljs$core$IFn$_invoke$arity$1(el)].join(''));
})());

var G__54638 = (i__54631 + (1));
i__54631 = G__54638;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54632),goldly$sci$loader$shadow_module$patch_url_$_iter__54629(cljs.core.chunk_rest(s__54630__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54632),null);
}
} else {
var i = cljs.core.first(s__54630__$2);
return cljs.core.cons((function (){var el = (uri[i]);
return (uri[i] = [base,cljs.core.str.cljs$core$IFn$_invoke$arity$1(el)].join(''));
})(),goldly$sci$loader$shadow_module$patch_url_$_iter__54629(cljs.core.rest(s__54630__$2)));
}
} else {
return null;
}
...
var promises = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54633){
var vec__54634 = p__54633;
var sci_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54634,(0),null);
...
var sci_def = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54637__$1,new cljs.core.Keyword(null,"sci-def","sci-def",-971575708));
var loadable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54637__$1,new cljs.core.Keyword(null,"loadable","loadable",-411421563));
