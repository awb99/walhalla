...
var f__41248__auto__ = (function (){var switch__41224__auto__ = (function (state_54822){
var state_val_54823 = (state_54822[(1)]);
if((state_val_54823 === (1))){
var inst_54814 = goldly.cljs.loader.load_cljs(static_QMARK_);
var state_54822__$1 = state_54822;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_54822__$1,(2),inst_54814);
} else {
if((state_val_54823 === (2))){
var inst_54816 = (state_54822[(2)]);
var inst_54817 = cljs.core.PersistentVector.EMPTY_NODE;
var inst_54818 = [new cljs.core.Keyword("webly","status","webly/status",-2111320042),new cljs.core.Keyword(null,"running","running",1554969103)];
var inst_54819 = (new cljs.core.PersistentVector(null,2,(5),inst_54817,inst_54818,null));
var inst_54820 = re_frame.core.dispatch(inst_54819);
var state_54822__$1 = (function (){var statearr_54824 = state_54822;
(statearr_54824[(7)] = inst_54816);
...
var statearr_54825 = [null,null,null,null,null,null,null,null];
(statearr_54825[(0)] = goldly$run$app$goldly_start_$_state_machine__41225__auto__);

(statearr_54825[(1)] = (1));

return statearr_54825;
});
var goldly$run$app$goldly_start_$_state_machine__41225__auto____1 = (function (state_54822){
while(true){
var ret_value__41226__auto__ = (function (){try{while(true){
var result__41227__auto__ = switch__41224__auto__(state_54822);
...
}catch (e54826){var ex__41228__auto__ = e54826;
var statearr_54827_54834 = state_54822;
(statearr_54827_54834[(2)] = ex__41228__auto__);


if(cljs.core.seq((state_54822[(4)]))){
var statearr_54828_54835 = state_54822;
(statearr_54828_54835[(1)] = cljs.core.first((state_54822[(4)])));
...
var G__54836 = state_54822;
state_54822 = G__54836;
continue;
} else {
...
goldly$run$app$goldly_start_$_state_machine__41225__auto__ = function(state_54822){
switch(arguments.length){
case 0:
return goldly$run$app$goldly_start_$_state_machine__41225__auto____0.call(this);
case 1:
return goldly$run$app$goldly_start_$_state_machine__41225__auto____1.call(this,state_54822);
}
...
var state__41249__auto__ = (function (){var statearr_54829 = f__41248__auto__();
(statearr_54829[(6)] = c__41247__auto__);
