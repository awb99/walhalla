...
var f__41382__auto__ = (function (){var switch__41305__auto__ = (function (state_55449){
var state_val_55450 = (state_55449[(1)]);
if((state_val_55450 === (1))){
var inst_55441 = goldly.cljs.loader.load_cljs(static_QMARK_);
var state_55449__$1 = state_55449;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_55449__$1,(2),inst_55441);
} else {
if((state_val_55450 === (2))){
var inst_55443 = (state_55449[(2)]);
var inst_55444 = cljs.core.PersistentVector.EMPTY_NODE;
var inst_55445 = [new cljs.core.Keyword("webly","status","webly/status",-2111320042),new cljs.core.Keyword(null,"running","running",1554969103)];
var inst_55446 = (new cljs.core.PersistentVector(null,2,(5),inst_55444,inst_55445,null));
var inst_55447 = re_frame.core.dispatch(inst_55446);
var state_55449__$1 = (function (){var statearr_55451 = state_55449;
(statearr_55451[(7)] = inst_55443);

return statearr_55451;
})();
return cljs.core.async.impl.ioc_helpers.return_chan(state_55449__$1,inst_55447);
} else {
return null;
}
}
...
var statearr_55452 = [null,null,null,null,null,null,null,null];
(statearr_55452[(0)] = goldly$run$app$goldly_start_$_state_machine__41306__auto__);

(statearr_55452[(1)] = (1));

return statearr_55452;
});
var goldly$run$app$goldly_start_$_state_machine__41306__auto____1 = (function (state_55449){
while(true){
var ret_value__41307__auto__ = (function (){try{while(true){
var result__41308__auto__ = switch__41305__auto__(state_55449);
...
}catch (e55453){var ex__41309__auto__ = e55453;
var statearr_55454_55461 = state_55449;
(statearr_55454_55461[(2)] = ex__41309__auto__);


if(cljs.core.seq((state_55449[(4)]))){
var statearr_55455_55462 = state_55449;
(statearr_55455_55462[(1)] = cljs.core.first((state_55449[(4)])));
...
var G__55463 = state_55449;
state_55449 = G__55463;
continue;
} else {
...
goldly$run$app$goldly_start_$_state_machine__41306__auto__ = function(state_55449){
switch(arguments.length){
case 0:
return goldly$run$app$goldly_start_$_state_machine__41306__auto____0.call(this);
case 1:
return goldly$run$app$goldly_start_$_state_machine__41306__auto____1.call(this,state_55449);
}
...
var state__41383__auto__ = (function (){var statearr_55456 = f__41382__auto__();
(statearr_55456[(6)] = c__41381__auto__);
