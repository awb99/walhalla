...
var f__41248__auto__ = (function (){var switch__41224__auto__ = (function (state_54803){
var state_val_54804 = (state_54803[(1)]);
if((state_val_54804 === (1))){
var inst_54795 = goldly.cljs.loader.load_cljs(static_QMARK_);
var state_54803__$1 = state_54803;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_54803__$1,(2),inst_54795);
} else {
if((state_val_54804 === (2))){
var inst_54797 = (state_54803[(2)]);
var inst_54798 = cljs.core.PersistentVector.EMPTY_NODE;
var inst_54799 = [new cljs.core.Keyword("webly","status","webly/status",-2111320042),new cljs.core.Keyword(null,"running","running",1554969103)];
var inst_54800 = (new cljs.core.PersistentVector(null,2,(5),inst_54798,inst_54799,null));
var inst_54801 = re_frame.core.dispatch(inst_54800);
var state_54803__$1 = (function (){var statearr_54805 = state_54803;
(statearr_54805[(7)] = inst_54797);
...
var statearr_54806 = [null,null,null,null,null,null,null,null];
(statearr_54806[(0)] = goldly$run$app$goldly_start_$_state_machine__41225__auto__);

(statearr_54806[(1)] = (1));

return statearr_54806;
});
var goldly$run$app$goldly_start_$_state_machine__41225__auto____1 = (function (state_54803){
while(true){
var ret_value__41226__auto__ = (function (){try{while(true){
var result__41227__auto__ = switch__41224__auto__(state_54803);
...
}catch (e54807){var ex__41228__auto__ = e54807;
var statearr_54808_54815 = state_54803;
(statearr_54808_54815[(2)] = ex__41228__auto__);


if(cljs.core.seq((state_54803[(4)]))){
var statearr_54809_54816 = state_54803;
(statearr_54809_54816[(1)] = cljs.core.first((state_54803[(4)])));
...
var G__54817 = state_54803;
state_54803 = G__54817;
continue;
} else {
...
goldly$run$app$goldly_start_$_state_machine__41225__auto__ = function(state_54803){
switch(arguments.length){
case 0:
return goldly$run$app$goldly_start_$_state_machine__41225__auto____0.call(this);
case 1:
return goldly$run$app$goldly_start_$_state_machine__41225__auto____1.call(this,state_54803);
}
...
var state__41249__auto__ = (function (){var statearr_54810 = f__41248__auto__();
(statearr_54810[(6)] = c__41247__auto__);
