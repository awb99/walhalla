...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function modular$oauth2$authorize$redirect$keywordize_$_iter__39880(s__39881){
return (new cljs.core.LazySeq(null,(function (){
var s__39881__$1 = s__39881;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__39881__$1);
if(temp__5804__auto__){
var s__39881__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39881__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__39881__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__39883 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__39882 = (0);
while(true){
if((i__39882 < size__5522__auto__)){
var vec__39890 = cljs.core._nth(c__5521__auto__,i__39882);
...
cljs.core.chunk_append(b__39883,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),v], null));

var G__39907 = (i__39882 + (1));
i__39882 = G__39907;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39883),modular$oauth2$authorize$redirect$keywordize_$_iter__39880(cljs.core.chunk_rest(s__39881__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39883),null);
}
} else {
var vec__39897 = cljs.core.first(s__39881__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),v], null),modular$oauth2$authorize$redirect$keywordize_$_iter__39880(cljs.core.rest(s__39881__$2)));
}
} else {
return null;
}
