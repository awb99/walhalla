...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("keybindings","init","keybindings/init",1829009079),(function (db,p__44981){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("palette","show","palette/show",234924316),(function (db,p__45011){
var vec__45013 = p__45011;
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("palette","filter-changed","palette/filter-changed",1488356424),(function (db,p__45026){
var vec__45027 = p__45026;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45027,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45027,(1),null);
...
var map__45040 = palette;
var map__45040__$1 = cljs.core.__destructure_map(map__45040);
var highlight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45040__$1,new cljs.core.Keyword(null,"highlight","highlight",-800930873));
var visible_items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45040__$1,new cljs.core.Keyword(null,"visible-items","visible-items",1351335131));
var maxidx = (cljs.core.count(visible_items) - (1));
var highlight_new = (function (){var G__45044 = direction;
var G__45044__$1 = (((G__45044 instanceof cljs.core.Keyword))?G__45044.fqn:null);
switch (G__45044__$1) {
case "up":
if((highlight > (0))){
return (highlight - (1));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45044__$1)].join('')));
...
var palette = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"keybindings","keybindings",656951934),new cljs.core.Keyword(null,"search","search",1564939822)], null));
var map__45047 = palette;
var map__45047__$1 = cljs.core.__destructure_map(map__45047);
var highlight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45047__$1,new cljs.core.Keyword(null,"highlight","highlight",-800930873));
var visible_items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45047__$1,new cljs.core.Keyword(null,"visible-items","visible-items",1351335131));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("palette","filter-keydown","palette/filter-keydown",488668044),(function (db,p__45054){
var vec__45055 = p__45054;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45055,(0),null);
var keycode = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45055,(1),null);
var G__45059 = keycode;
switch (G__45059) {
case (38):
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("palette","action","palette/action",-49869325),(function (db,p__45061){
var vec__45065 = p__45061;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45065,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45065,(1),null);
