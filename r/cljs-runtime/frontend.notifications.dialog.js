...
var n_class = (function (){var G__46014 = notification_type__$1;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46014__$1)].join('')));

}
})();
return ["notification ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n_class)].join('');
});
frontend.notifications.dialog.notification_component = (function frontend$notifications$dialog$notification_component(p__46016){
var map__46017 = p__46016;
var map__46017__$1 = cljs.core.__destructure_map(map__46017);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46017__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46017__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46017__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"position","position",-2011731912),"fixed",new cljs.core.Keyword(null,"width","width",-384071477),"calc(100vw - 3em)",new cljs.core.Keyword(null,"top","top",-1856271961),"6em",new cljs.core.Keyword(null,"right","right",-452581833),"1em",new cljs.core.Keyword(null,"z-index","z-index",1892827090),(300),new cljs.core.Keyword(null,"overflow","overflow",2058931880),"hidden"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736),[".notification {","opacity: 0.8; ","margin-bottom 0.5em !important; ","} ",".notification:hover { ","opacity: 1; ","} "].join('')], null),(cljs.core.truth_(cljs.core.not_empty(cljs.core.deref(nots_subs)))?cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function frontend$notifications$dialog$notifications_container_$_iter__46018(s__46019){
return (new cljs.core.LazySeq(null,(function (){
var s__46019__$1 = s__46019;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__46019__$1);
if(temp__5804__auto__){
var s__46019__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46019__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__46019__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__46021 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__46020 = (0);
while(true){
if((i__46020 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__46020);
cljs.core.chunk_append(b__46021,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [frontend.notifications.dialog.notification_component,n], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["notify-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(n))].join('')], null)));

var G__46034 = (i__46020 + (1));
i__46020 = G__46034;
continue;
} else {
return true;
