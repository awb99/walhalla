...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43660 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43660(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43661 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43661(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43670 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43670(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43672 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43672(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43675 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43675(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43678 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43678(reader);
}
});
...
var G__43783 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43784 = s.append(c);
c = G__43783;
s = G__43784;
continue;
}
