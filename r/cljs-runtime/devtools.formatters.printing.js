...
var len__5769__auto___41789 = arguments.length;
var i__5770__auto___41790 = (0);
while(true){
if((i__5770__auto___41790 < len__5769__auto___41789)){
args__5775__auto__.push((arguments[i__5770__auto___41790]));

var G__41792 = (i__5770__auto___41790 + (1));
i__5770__auto___41790 = G__41792;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41637){
var G__41638 = cljs.core.first(seq41637);
var seq41637__$1 = cljs.core.next(seq41637);
var G__41639 = cljs.core.first(seq41637__$1);
var seq41637__$2 = cljs.core.next(seq41637__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41638,G__41639,seq41637__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41669_SHARP_){
return (!((cljs.core.meta(p1__41669_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41704__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41710){var _e__40508__auto__ = e41710;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e41717){var _e__40508__auto__ = e41717;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41734 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41735 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41735);

try{var map__41737 = opts;
var map__41737__$1 = cljs.core.__destructure_map(map__41737);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41737__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41734);
}});
...
var temp__5802__auto___41852 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___41852)){
var managed_print_level_41853 = temp__5802__auto___41852;
var _STAR_print_level_STAR__orig_val__41757_41854 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41758_41855 = managed_print_level_41853;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41758_41855);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41745_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41745_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41757_41854);
}} else {
job_fn();
}
