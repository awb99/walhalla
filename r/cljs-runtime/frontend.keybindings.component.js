...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-row.items-stretch.mb-0.border.border-solid.border-blue-800.p-0","div.flex.flex-row.items-stretch.mb-0.border.border-solid.border-blue-800.p-0",1048386469),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full ml-2 bg-blue-200 text-lg",new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),query,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__44930_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("palette","filter-changed","palette/filter-changed",1488356424),p1__44930_SHARP_.target.value], null));
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__44931_SHARP_){
return re_frame.core.dispatch_sync(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("palette","filter-keydown","palette/filter-keydown",488668044),p1__44931_SHARP_.which], null));
}),new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__44932_SHARP_){
if(cljs.core.truth_(p1__44932_SHARP_)){
return p1__44932_SHARP_.focus();
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(active_QMARK_)?"bg-red-300":null),new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__44960_SHARP_){
if(cljs.core.truth_(active_QMARK_)){
return frontend.keybindings.component.scroll_into_view(p1__44960_SHARP_);
} else {
return null;
}
...
var map__44974 = cljs.core.deref(palette);
var map__44974__$1 = cljs.core.__destructure_map(map__44974);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44974__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var visible_items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44974__$1,new cljs.core.Keyword(null,"visible-items","visible-items",1351335131));
var highlight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44974__$1,new cljs.core.Keyword(null,"highlight","highlight",-800930873));
