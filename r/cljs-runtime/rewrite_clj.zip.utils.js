...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__71162,k,f){
var vec__71163 = p__71162;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71163,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71163,(1),null);
var loc = vec__71163;
...
var G__71210 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__71210;
continue;
}
break;
...
var G__71211 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__71211;
continue;
} else {
return zloc__$1;
...
var G__71213 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__71213;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__71189){
var vec__71191 = p__71189;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71191,(0),null);
var map__71194 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71191,(1),null);
var map__71194__$1 = cljs.core.__destructure_map(map__71194);
var path = map__71194__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71194__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__71191;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__71197){
var vec__71198 = p__71197;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71198,(0),null);
var map__71201 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71198,(1),null);
var map__71201__$1 = cljs.core.__destructure_map(map__71201);
var path = map__71201__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71201__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__71198;
if(cljs.core.seq(r)){
...
var vec__71203 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71203,(0),null);
var map__71206 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71203,(1),null);
var map__71206__$1 = cljs.core.__destructure_map(map__71206);
var path = map__71206__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71206__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71206__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71206__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71206__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
