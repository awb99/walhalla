...
return taoensso.truss.impl._invar_violation_BANG_(true,new cljs.core.Symbol(null,"modular.ws.msg-handler","modular.ws.msg-handler",-439600703,null),16,39,"jar:file:/home/florian/.m2/repository/org/pinkgorilla/webly/0.4.615/webly-0.4.615.jar!/modular/ws/msg_handler.cljs",new cljs.core.Symbol(null,"vector?","vector?",-61367869,null),new cljs.core.Symbol(null,"?data","?data",1631060094,null),_QMARK_data,e,null);
}
})();
...
modular.ws.msg_handler._event_msg_handler.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("chsk","ws-ping","chsk/ws-ping",191675304),(function (p__41475){
var map__41476 = p__41475;
var map__41476__$1 = cljs.core.__destructure_map(map__41476);
var ev_msg = map__41476__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41476__$1,new cljs.core.Keyword(null,"event","event",301435442));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41476__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var _QMARK_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41476__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var ring_req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41476__$1,new cljs.core.Keyword(null,"ring-req","ring-req",-747861961));
var _QMARK_reply_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41476__$1,new cljs.core.Keyword(null,"?reply-fn","?reply-fn",-1479510592));
var send_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41476__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
...
modular.ws.msg_handler._event_msg_handler.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"default","default",-1987822328),(function (p__41500){
var map__41501 = p__41500;
var map__41501__$1 = cljs.core.__destructure_map(map__41501);
var ev_msg = map__41501__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41501__$1,new cljs.core.Keyword(null,"event","event",301435442));
 ...
 */
modular.ws.msg_handler.event_msg_handler = (function modular$ws$msg_handler$event_msg_handler(p__41516){
var map__41519 = p__41516;
var map__41519__$1 = cljs.core.__destructure_map(map__41519);
var req = map__41519__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41519__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var _QMARK_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41519__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41519__$1,new cljs.core.Keyword(null,"event","event",301435442));
