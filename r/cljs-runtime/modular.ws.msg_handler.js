...
modular.ws.msg_handler._event_msg_handler.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("chsk","handshake","chsk/handshake",64910686),(function (p__41441){
var map__41442 = p__41441;
var map__41442__$1 = cljs.core.__destructure_map(map__41442);
var ev_msg = map__41442__$1;
var _QMARK_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41442__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var vec__41443 = _QMARK_data;
var _QMARK_uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41443,(0),null);
var _QMARK_csrf_token = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41443,(1),null);
var _QMARK_handshake_data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41443,(2),null);
...
modular.ws.msg_handler._event_msg_handler.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__41446){
var map__41447 = p__41446;
var map__41447__$1 = cljs.core.__destructure_map(map__41447);
var ev_msg = map__41447__$1;
var _QMARK_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41447__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var vec__41448 = (function (){var e = (function (){try{if(cljs.core.vector_QMARK_(_QMARK_data)){
return null;
} else {
...
return taoensso.truss.impl._invar_violation_BANG_(true,new cljs.core.Symbol(null,"modular.ws.msg-handler","modular.ws.msg-handler",-439600703,null),16,39,"jar:file:/home/florian/.m2/repository/org/pinkgorilla/webly/0.4.619/webly-0.4.619.jar!/modular/ws/msg_handler.cljs",new cljs.core.Symbol(null,"vector?","vector?",-61367869,null),new cljs.core.Symbol(null,"?data","?data",1631060094,null),_QMARK_data,e,null);
}
})();
var old_state_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41448,(0),null);
var new_state_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41448,(1),null);
...
modular.ws.msg_handler._event_msg_handler.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("chsk","ws-ping","chsk/ws-ping",191675304),(function (p__41464){
var map__41465 = p__41464;
var map__41465__$1 = cljs.core.__destructure_map(map__41465);
var ev_msg = map__41465__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41465__$1,new cljs.core.Keyword(null,"event","event",301435442));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41465__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var _QMARK_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41465__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var ring_req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41465__$1,new cljs.core.Keyword(null,"ring-req","ring-req",-747861961));
var _QMARK_reply_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41465__$1,new cljs.core.Keyword(null,"?reply-fn","?reply-fn",-1479510592));
var send_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41465__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
...
modular.ws.msg_handler._event_msg_handler.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__41475){
var map__41477 = p__41475;
var map__41477__$1 = cljs.core.__destructure_map(map__41477);
var ev_msg = map__41477__$1;
var _QMARK_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41477__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
...
modular.ws.msg_handler._event_msg_handler.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"default","default",-1987822328),(function (p__41482){
var map__41484 = p__41482;
var map__41484__$1 = cljs.core.__destructure_map(map__41484);
var ev_msg = map__41484__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41484__$1,new cljs.core.Keyword(null,"event","event",301435442));
 ...
 */
modular.ws.msg_handler.event_msg_handler = (function modular$ws$msg_handler$event_msg_handler(p__41490){
var map__41491 = p__41490;
var map__41491__$1 = cljs.core.__destructure_map(map__41491);
var req = map__41491__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41491__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var _QMARK_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41491__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41491__$1,new cljs.core.Keyword(null,"event","event",301435442));
