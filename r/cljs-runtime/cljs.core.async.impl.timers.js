...
var i_48680 = (self__.level + (1));
while(true){
if((i_48680 <= (new_level + (1)))){
(update[i_48680] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_48682 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_48682[i]));
} else {
x__$2.forward.push((((i < links_48682.length))?(links_48682[i]):null));
}

if((i < links_48682.length)){
(links_48682[i] = x__$2);
} else {
links_48682.push(x__$2);
}
...
var i_48685 = (0);
while(true){
if((i_48685 <= self__.level)){
var links_48686 = (update[i_48685]).forward;
if((x__$1 === (((i_48685 < links_48686.length))?(links_48686[i_48685]):null))){
(links_48686[i_48685] = (x__$1.forward[i_48685]));

var G__48689 = (i_48685 + (1));
i_48685 = G__48689;
continue;
} else {
var G__48690 = (i_48685 + (1));
i_48685 = G__48690;
continue;
}
} else {
...
var G__48695 = nx;
var G__48696 = (level__$1 - (1));
x = G__48695;
level__$1 = G__48696;
continue;
} else {
var G__48697 = x;
var G__48698 = (level__$1 - (1));
x = G__48697;
level__$1 = G__48698;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__48700 = nx;
var G__48701 = (level__$1 - (1));
x = G__48700;
level__$1 = G__48701;
continue;
} else {
var G__48702 = x;
var G__48703 = (level__$1 - (1));
x = G__48702;
level__$1 = G__48703;
continue;
}
