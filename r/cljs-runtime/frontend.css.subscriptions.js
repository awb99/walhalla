...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("css","theme","css/theme",-1248044221),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__44904){
var vec__44905 = p__44904;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44905,(0),null);
var map__44908 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"theme","theme",-1247880880)], null));
var map__44908__$1 = cljs.core.__destructure_map(map__44908);
var available = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44908__$1,new cljs.core.Keyword(null,"available","available",-1470697127),cljs.core.PersistentArrayMap.EMPTY);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44908__$1,new cljs.core.Keyword(null,"current","current",-1088038603),cljs.core.PersistentArrayMap.EMPTY);
