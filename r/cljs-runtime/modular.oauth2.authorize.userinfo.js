...
var config_41369 = modular.oauth2.provider.get_provider_config(provider);
var uri_41370 = new cljs.core.Keyword(null,"user","user",1532431356).cljs$core$IFn$_invoke$arity$1(config_41369);
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"request","request",1772954723),provider,uri_41370,new cljs.core.Keyword("oauth2","set-user","oauth2/set-user",-545966060)], null));
...
var vec__41345 = p__41342;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41345,(0),null);
var provider = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41345,(1),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41345,(2),null);
