...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("oauth2","set-user","oauth2/set-user",-545966060),(function (db,p__41338){
var vec__41339 = p__41338;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41339,(0),null);
var provider = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41339,(1),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41339,(2),null);
var map__41342 = modular.oauth2.provider.parse_userinfo(provider,data);
var map__41342__$1 = cljs.core.__destructure_map(map__41342);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41342__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41342__$1,new cljs.core.Keyword(null,"email","email",1415816706));
