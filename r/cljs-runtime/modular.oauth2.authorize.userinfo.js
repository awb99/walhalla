...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41320__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__41321 = p__41319;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41321,(0),null);
var provider = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41321,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("oauth2","set-user","oauth2/set-user",-545966060),(function (db,p__41342){
...
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41343,(2),null);
var map__41346 = modular.oauth2.provider.parse_userinfo(provider,data);
var map__41346__$1 = cljs.core.__destructure_map(map__41346);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41346__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41346__$1,new cljs.core.Keyword(null,"email","email",1415816706));
