...
var args__$1 = args.map((function (p1__64661_SHARP_){
return sci.impl.types.eval(p1__64661_SHARP_,ctx,bindings);
}));
...
return Reflect.construct(constructor$,args.map((function (p1__64717_SHARP_){
return sci.impl.types.eval(p1__64717_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__64728_SHARP_){
return sci.impl.types.eval(p1__64728_SHARP_,ctx,bindings);
})));
});
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__64780 = temp__5802__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64780,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64780,(1),null);
